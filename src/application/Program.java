...
public class Program {
	...
	public static void main(String[] args) throws ParseException {
		...
		RentalCar rentalCar = new RentalCar(start, finish, new Vehicle(carModel));
		...
		System.out.println("Total Payment: " + String.format("%.2f", rentalCar.getInvoice().getTotalPayment()));
